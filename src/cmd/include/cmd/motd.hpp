...
#ifndef _UNREALIRCD_CMD_MOTD_HPP
#define _UNREALIRCD_CMD_MOTD_HPP
...
/**
 * Unreal Command Handler for "MOTD"
 */
class UnrealCH_motd
{
public:
	UnrealCH_motd(UnrealModule* mptr);
	~UnrealCH_motd();
...
#endif /* _UNREALIRCD_CMD_MOTD_HPP */
