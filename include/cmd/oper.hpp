...
#ifndef _UNREALIRCD_CMD_OPER_HPP
#define _UNREALIRCD_CMD_OPER_HPP
...
/**
 * Unreal Command Handler for "OPER"
 */
class UnrealCH_oper
{
public:
	UnrealCH_oper(UnrealModule* mptr);
	~UnrealCH_oper();
...
#endif /* _UNREALIRCD_CMD_OPER_HPP */
