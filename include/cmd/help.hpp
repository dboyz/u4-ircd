...
#ifndef _UNREALIRCD_CMD_HELP_HPP
#define _UNREALIRCD_CMD_HELP_HPP
...
/**
 * Unreal Command Handler for "HELP"
 */
class UnrealCH_help
{
public:
	UnrealCH_help(UnrealModule* mptr);
	~UnrealCH_help();
...
#endif /* _UNREALIRCD_CMD_HELP_HPP */
