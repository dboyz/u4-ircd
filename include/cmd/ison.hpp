...
#ifndef _UNREALIRCD_CMD_ISON_HPP
#define _UNREALIRCD_CMD_ISON_HPP
...
/**
 * Unreal Command Handler for "ISON"
 */
class UnrealCH_ison
{
public:
	UnrealCH_ison(UnrealModule* mptr);
	~UnrealCH_ison();
...
#endif /* _UNREALIRCD_CMD_ISON_HPP */
