...
#ifndef _UNREALIRCD_CMD_LSMOD_HPP
#define _UNREALIRCD_CMD_LSMOD_HPP
...
/**
 * Unreal Command Handler for "LSMOD"
 */
class UnrealCH_lsmod
{
public:
	UnrealCH_lsmod(UnrealModule* mptr);
	~UnrealCH_lsmod();
...
#endif /* _UNREALIRCD_CMD_LSMOD_HPP */
