...
#ifndef _UNREALIRCD_CMD_AWAY_HPP
#define _UNREALIRCD_CMD_AWAY_HPP
...
/**
 * Unreal Command Handler for "AWAY"
 */
class UnrealCH_away
{
public:
	UnrealCH_away(UnrealModule* mptr);
	~UnrealCH_away();
...
#endif /* _UNREALIRCD_CMD_AWAY_HPP */
