...
#ifndef _UNREALIRCD_CMD_INSMOD_HPP
#define _UNREALIRCD_CMD_INSMOD_HPP
...
/**
 * Unreal Command Handler for "INSMOD"
 */
class UnrealCH_insmod
{
public:
	UnrealCH_insmod(UnrealModule* mptr);
	~UnrealCH_insmod();
...
#endif /* _UNREALIRCD_CMD_INSMOD_HPP */
